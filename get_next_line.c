...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/07/14 16:48:43 by jlow              #+#    #+#             */
/*   Updated: 2023/08/11 16:30:56 by jlow             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char	*get_next_line(int fd)
{
	...
	backup_buffer = read_file_into_buffer(fd, backup_buffer);
	result_buffer = split_lines_before(backup_buffer);
	backup_buffer = split_lines_after(backup_buffer);
